...
<html lang="en">
  <head>
    ...
    <style>
      ...
      .video-container {
          ...
          padding-bottom: 46.25%; /* 16:9 aspect ratio (for 16:9 videos) */
          height: 0;
          overflow: hidden;
          width: 90%;
          border-radius: 20px;
      ...
      /* Make iframe responsive within the container */
  ...
  <body>
      ...
      <div class="container d-flex align-items-center">
        ...
        <nav id="navbar" class="navbar">
          <ul>
            ...
            <li><a class="nav-link scrollto" href="#eventCalendar">Event Calendar</a></li>
            ...
            <div class="row">
                <div class="col-lg-6 d-flex flex-column justify-content-center pt-4 pt-lg-0 order-2 order-lg-1" data-aos="fade-up" data-aos-delay="200">
                    ...
                    if ($home_result->num_rows > 0) {
                        ...
                        echo '<span style="font-size: 1.25rem; text-align: justify">' . $home_content . '</span>';
                    } else {
                        echo "<h1 style='text-align: center'>No Published Home Page found.</h1>";
                    }
                    ?>
                </div>
                <div class="col-lg-6 order-1 order-lg-2 hero-img" data-aos="zoom-in" data-aos-delay="200" style="display: flex; justify-content: center; align-items: center;">
                    <?php
                    if ($home_result->num_rows > 0) {
                        // Display the home image if available
                        echo '<img src="' . $home_img . '" class="img-fluid animated" alt="" />';
                    } else {
                        // Display a default image or a message for no home image
                        echo '<img src="path/to/default-image.png" class="img-fluid animated" alt="No Home Image" />';
                    }
                    ?>
                </div>
            </div>
    ...
    <main id="main">
      ...
      <!-- Start of Videos Updates -->
      <?php
      $video_query = "SELECT * FROM videostable WHERE video_status = 1";
      $video_result = $con->query($video_query);
      ...
      ?>
          <section id="videos" class="videos" style="border-bottom: 0px solid">
      ...
      ?>
      <!-- End of Videos Updates -->


      <!-- ======= Clients Section ======= -->
      <section id="about" class="clients section1-bg"> 
        <div class="container">
          <div class="section-title">
            <h2>About</h2>
          </div>
          <div class="row clients-container" data-aos="zoom-in">
            <div class="clients-content w-50 col-lg-2 col-md-4 col-6 d-flex align-items-center">
              ...
              if ($aboutrotc_result->num_rows > 0) {
                  ...
                  echo '<span style="font-size: 1rem; text-align: justify;">' . $about_content . '</span>';
              } else {
                echo "<h1 style='text-align: center'>No Published ROTC Page found.</h1>";
              }
              ?>
              <!-- <img
            ...
            <?php
              ...
              if ($aboutcwts_result->num_rows > 0) {
                  ...
                  echo "<h1 style='text-align: center'>No Published CWTS Page found.</h1>";
              }
              ?>
              <!-- <img
      ...
      if ($newsupdate_result->num_rows > 0) {
          $firstRow = true;
      ?>
          <section id="newupdate" class="newsupdate" style="background-color: #effbfc; border-top: 0 solid #c5e2f2">
                  ...
                  <div id="carouselExampleCaptions" class="carousel carousel-dark slide" data-bs-ride="carousel" data-bs-interval="300000">
                      ...
                      <div class="carousel-inner">
                          ...
                          while ($newsupdate_data = $newsupdate_result->fetch_assoc()) {
                              ...
                              $newsId = $newsupdate_data['newsupdate_id'];
      ...
      <?php
      } // End of check for rows in the result
      ?>
      <!-- End of News Updates -->


      <!-- ======= Portfolio Section ======= -->
      <section id="portfolio" class="portfolio section1-bg">
        <div class="container" data-aos="fade-up">
          ...
          <ul
            ...
            <li data-filter=".filter-card">CWTS</li>
            <li data-filter=".filter-app">ROTC</li>
            <!-- <li data-filter=".filter-web">Goal</li> -->
          </ul>

          <div class="row portfolio-container" data-aos="fade-up" data-aos-delay="200" style="margin: 0 1.5rem;">
          <?php
              ...
              if ($gallery_result->num_rows > 0) {
                  while ($gallery_row = $gallery_result->fetch_assoc()) {
                      ...
                      echo '    
                            <div class="col-lg-4 col-md-6 portfolio-item '.$filterClass.'">
                              <a href="' . $gallery_img . '" data-gallery="portfolioGallery" class="portfolio-lightbox preview-link" title="<h6> '. htmlspecialchars($galleryTime) . '</h6><h4>' . htmlspecialchars($galleryTitle) . '</h4>">
                  ...
                  echo "<h1 style='text-align: center'>No published pictures found.</h1>";
              }
          ?>
      ...
      <section id="eventCalendar" class="newsupdate section-bg" style="border-top: 0px solid #c5e2f2">
        <div class="container" data-aos="fade-up" style="display: flex; flex-direction: column; justify-content: center; align-items: center;">
          <div class="section-title mt-5 pb-0">
      ...
      <!-- ======= Team Section ======= -->
      <?php
      $checkOnOff = "SELECT * FROM teamtable LIMIT 1";
      $checkOnOffResult = $con->query($checkOnOff);
      $checkOnOffData = $checkOnOffResult->fetch_assoc();
      $onOff =$checkOnOffData['onOff'];
            ...
            <div class="container" data-aos="fade-up">
              ...
              <div class="row">
                ...
                if($team_result->num_rows > 0){
                  ...
                  echo "<h1 style='text-align: center'>No Published Team Page found.</h1>";
                }
                ?>
              </div>
            </div>
      ...
      <section id="faq" class="faq section-bg">
          <div class="container" data-aos="fade-up">
              ...
              <div class="faq-list">
                  ...
                  <ul>
                      <?php
                      // Loop through the database result and display each FAQ item.
                      ...
                      <li data-aos="fade-up" data-aos-delay="100">
                          ...
                          <div id="faq-list-<?php echo $faq_id; ?>" class="collapse <?php if ($faq_status == 'active') echo 'show'; ?>"
                  ...
                  <?php
                      ...
                      echo "<h1 style='text-align: center'>No Published FAQ Page found.</h1>";
                  }
                  ?>
              </div>
          </div>
...
<script>
  $(document).ready(function() {
    // Attach click event handler to the "Read More" button
    $('.read-more-btn').on('click', function() {
      // Get the newsId from the hidden input field in the same carousel item
      var newsId = $(this).siblings('input[type="hidden"]').val();

      // Create a form dynamically
      var form = $('<form action="NewsAndUpdate.php" method="post"></form>');
      // Add the newsId as a hidden input field to the form
