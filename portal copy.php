...
<?php
    if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["signin"])) {
        ...
        $stmt = $con->prepare("SELECT * FROM useraccount WHERE email_address = ? ORDER BY user_account_id DESC");
                    ...
                    <form  method="POST" id="myForm">
                        ...
                        <div class="dropdown-container d-flex flex-rows gap-2 form-element">
                            <div class="flex-1 w-100">
                                <select class="form-control" id="year-level" name="yearlevel">
                            ...
                            <div>
                                <select class="form-control" id="student_section" name="student_section" style="width: 100px;">
                        ...
                        <div class="form-element dropdown-container d-flex flex-rows gap-2">
                            <div class="flex-grow-1" style="min-width: 100px;">
                                <select class="form-control" id="birthday-month" name="birthday-month">
                            ...
                            <div class="dropdown-container d-flex flex-rows gap-2">
                                ...
                                <div style="min-width: 100px;">
                                    <select class="form-control" id="birthday-year" name="birthday-year">
                        ...
                        <?php
                            ...
                            if($schoolyear_data){
                                ...
                                echo"<script>console.log($enrolledcount);</script>";
                        ...
                        ?>
                        <div class="form-element" style="width: 100px;">
