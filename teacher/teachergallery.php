            ...
            <div class="studentList-container">
                <div class="buttonsContainer" style="margin-top: 1.5rem;">
                  <div class="buttonHolders">
                    <a href="./teacherprofile.php" class="btn btn-secondary"><i class='bx bx-arrow-back'></i>Profile</a>
                      ...
                      <div class="function-btn" style="display: none; width: 100%;">
                          <div class="buttonsContainer">
                            <div class="buttonHolder">
                              <button type="submit" class="btn btn-primary setbtn" name="set_profile_picture"><i class="fas fa-user"></i>Set Profile Picture</button>
                              <button type="submit" class="btn btn-danger deletebtn" name="delete_picture"><i class="fas fa-trash-alt"></i>Delete Profile Picture</button>
                            </div>
                          </div>
                      </div>
                  </form>
            ...
            success: function(response) {
                ...
                if (data.success) {
                    Swal.fire({
                        ...
                        window.location.href = './teachergallery.php';
                    });
                } else {
                    Swal.fire({
                        icon: 'error',
