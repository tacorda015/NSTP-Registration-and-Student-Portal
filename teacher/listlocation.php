...
?>
      <div class="home-main-container">
        <div class="studentList-containers">
          ...
          <div class='buttonsContainer'>
              <div class='buttonHolder'>
                <button class="marker-button btn btn-primary" id="goToMyLocationButton" onclick="goToMyLocation()">
                  <!-- <i class='bx bx-current-location' style="font-size: 24px;"></i> -->
          ...
          echo "<thead class=\"custom-thead\"><tr><th>Location Name</th><th class='thAction'>Show Routes</th><th class='thAction'>Action</th></tr></thead>";
          ...
          echo "<td data-label='Action'>
                  <div class = 'groupButton'>
                    <button type='button' class='publish-button btn btn-primary' data-location-id='" . $location_id . "' data-publish='0'>
                    <i class='bx bx-layer-minus'></i>Unpublish</button>
                    <button type='button' class='delete-button btn btn-danger' data-location-id='" . $location_id . "'>
          ...
          echo "<td data-label='Action'>
                  <div class = 'groupButton'>
                    <button type='button' class='publish-button btn btn-primary' data-location-id='" . $location_id . "' data-publish='1'>
                    <i class='bx bx-layer-plus' ></i>Publish</button>
                    <button type='button' class='delete-button btn btn-danger' data-location-id='" . $location_id . "'>
                    <i class='bx bx-trash'></i>Delete</button>
                  </div>
                </td>";
...
<script src="./js/listlocation_deleteLocation.js"></script>
<script src="./js/listlocation_updatePublishStatus.js"></script>
<script src="./js/listlocation_saveLocationToDatabase.js"></script>
<script src="./js/listlocation_showRoutesButton.js"></script>
<script src="./js/listlocation_updateRoute.js"></script>
<script src="./js/listlocation_watchPositionAndRoute.js"></script>
<script src="./js/listlocation_goToMyLocation.js"></script>
<script src="./js/listlocation_calculateRoute.js"></script>
<script>
  ...
  map.on('click', function (e) {
    ...
    .then(function (response) {
      ...
      var popupContent = '<div style="display: grid;">' + '<p>' + placeName + '</p>' + '<button class="add-activity-button btn btn-primary">Add Activity Location</button>' + '</div>';
