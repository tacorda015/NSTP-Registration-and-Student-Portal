  ...
  <div class="wrapper">
    ...
    <div class="sidebar close">
      ...
      <ul class="nav-links">
        ...
        <li>
          <div class="iocn-link">
            <a href="./attendance.php"><i class="bi bi-calendar3"></i>
        ...
        <li>
          <div class="iocn-link">
            <a href="./qrcode.php"><i class="bi bi-qr-code"></i>
        ...
        <li>
          <div class="iocn-link">
            <a href="./module.php"><i class="bi bi-journals"></i>
        ...
        <li>
          <div class="iocn-link">
            <a href="./locationlist.php"><i class="bi bi-geo-alt"></i>
        ...
        <li>
          <div class="iocn-link">
            <a href="./schedule.php"><i class="bi bi-calendar-event"></i>
        ...
        <li class="student-sidebar">
          ...
          <!-- <ul class="sub-menu">
            <li><a href="./announcement.php"><i class="bi bi-bell"></i>Announcement</a></li>
          </ul> -->
        </li>
      </ul>
    </div>
    ...
    <section class="home-section">
      <div class="home-content">
          ...
          <div class="menu">
            <ul>
              <li>
                <a href="./profile.php"><i class="bi bi-person-vcard"></i>Profile</a>
              </li>
              <li>
