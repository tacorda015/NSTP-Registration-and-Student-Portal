...
$check_picture = "SELECT * FROM useraccount WHERE user_account_id = $user_id";
$check_picture_result = $con->query($check_picture);
$check_picture_data = $check_picture_result->fetch_assoc();

$role_id = $check_picture_data['role_account_id'];

$role = "SELECT * FROM roleaccount WHERE role_account_id = $role_id";
                    ...
                    <div class="function-btn" style="display: none; width: 100%;">
                        <div class="buttonsContainer">
                          <div class="buttonHolder">
                            <button type="submit" class="btn btn-primary setbtn" name="set_profile_picture"><i class="fas fa-user"></i>Set Profile</button>
                            <button type="submit" class="btn btn-danger deletebtn" name="delete_picture"><i class="fas fa-trash-alt"></i>Delete Picture</button>
                          </div>
                        </div>
                    </div>
                </form>
