            ...
            <div class="modal fade" id="addstudentmodal" tabindex="1" aria-labelledby="exampleModalLabel" aria-hidden="true">
              <div class="modal-dialog">
                ...
                if($schoolyear_result->num_rows > 0){
                    ...
                    $query = "SELECT * FROM enrolledstudent WHERE schoolyear_id = $schoolyear_id AND semester_id = $semester_id";
                    ...
                    if (mysqli_num_rows($result) > 0) {
                        ...
                        echo "<thead class=\"custom-thead\"><tr><th>Student Number</th><th>Student Name</th><th>Register Status</th><th class='thAction'>Actions</th></tr></thead>";
                        echo "<tbody id='file-table-body' class='table-group-divider'>";
                        // $currentRow = $offset + 1;
                        ...
                        echo '<table class="table">
                            <thead class="custom-thead"><tr><th>Student Number</th><th>Student Name</th><th>Register Status</th><th class="thAction">Actions</th></tr></thead>
                            <tbody>
                                <tr>
